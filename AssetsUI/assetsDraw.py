...
def draw_data(self, context, obj):
	...
	if scene.showconstraints == True:
		if obj.mode != "POSE":
			owner = "OBJECT"
			constraints_ui.drawconstraints(self, context, box, owner, row, obj)
		else:
			owner = "BONE"
			constraints_ui.draw_boneconstraints(self, context, box, owner, row, obj)
