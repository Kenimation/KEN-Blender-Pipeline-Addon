...
bpy.types.Object.flipBone = BoolProperty(default=True)
...
bpy.types.Object.SubClassesAlt = EnumProperty(
    default='one',
    items=[('one', 'Design', ''),
            ('two', 'Materials', ''),
            ('three', 'Posing', ''),
...
bpy.types.Object.NoFace = EnumProperty(
    update = minecraftDefs.update_NoFace,
    default='0',
    items=[('0', 'Face', ''),
           ('1', 'No Face', '')
           ]
...
bpy.types.Object.ParentBones = EnumProperty(
    update = minecraftDefs.update_ParentBones,
    default=None,
