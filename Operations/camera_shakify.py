...
import bpy
from bpy.types import Camera, Context, Action
...
class OBJECT_UL_camera_shake_items(bpy.types.UIList):
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        ...
        if self.layout_type in {'DEFAULT', 'COMPACT'}:
            layout.label(text="", icon='FCURVE_SNAPSHOT')
            layout.prop(item, "shake_type", text="", emboss=False)
            layout.prop(item, "influence", text="Influence", expand=False, slider=True, emboss=False)
            layout.prop(item, "scale", text="Scale", expand=False, slider=True, emboss=False)
