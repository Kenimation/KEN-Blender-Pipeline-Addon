...
class Images_Clean_Resources(bpy.types.Operator):
    bl_idname = "images.clean_resources"
    bl_label = "Clean Images Resources"
    ...
    def execute(self, context):
        ...
        self.report({"INFO"}, "Images Clean.")

        return {"FINISHED"}
    
class Materials_Clean_Resources(bpy.types.Operator):
    bl_idname = "materials.clean_resources"
    bl_label = "Clean Materials Resources"
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def execute(self, context):
        ...
        self.report({"INFO"}, "Materials Clean.")

        return {"FINISHED"}
    

classes = (
            Images_Clean_Resources,
            Materials_Clean_Resources,
          )
