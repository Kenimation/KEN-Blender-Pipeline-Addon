...
from .Anime import AnimeExtraProperties
...
def drwatexture(list, material_obj, slot):
    color = material_obj.material_slots[slot].material.node_tree.nodes['Base Color'].image
    shadow = material_obj.material_slots[slot].material.node_tree.nodes['Shadow Color'].image
    lim = material_obj.material_slots[slot].material.node_tree.nodes['Base lim'].image
    row = list.row()
    row.prop(color, "filepath", text = "Base")
    row = list.row()
    row.prop(shadow, "filepath", text = "Shadow")
    row = list.row()
    row.prop(lim, "filepath", text = "lim")
