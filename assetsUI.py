    ...
    def draw(self, context):
        ...
        if scene.myProps == 'one':
            ...
            if obj:
                ...
                if obj.get("RIG_ID") not in AnimeProperties.kenriglist:
                    if scene.object_properties == True:
                        assetsDraw.drawobj_properties(self,context, obj)
                    
                assetsDraw.draw_edit(scene, box, obj)
                ...
                assetsDraw.draw_ken_mcrig(addon_prefs, self, context, obj)
                assetsDraw.draw_ken_animerig(addon_prefs, self, context, obj)
                if obj.get("RIG_ID") in AnimeProperties.kenriglist:
                    if scene.object_properties == True:
                        assetsDraw.drawobj_properties(self,context, obj)
